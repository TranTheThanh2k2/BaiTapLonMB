...
const BankSucces = ({route,navigation}) => {
    const {soTK} = route.params;
    const {nganHang} = route.params;
    const {tenTK} = route.params;
    ...
    return (
        <View style={{flex:1,alignItems:'center',justifyContent:'center',backgroundColor:'#d6d4d4'}}>
            <View style={{backgroundColor:'#00008B',position:'relative',flex:2,width:'100%',alignItems:'center'}}>
                <View style={{width:'50px',alignItems:'center',justifyContent:'center',height:'50px',borderRadius:'50%',backgroundColor:'white'}}>
                ...
                <View style={{width:'90%',backgroundColor:'white',marginTop:'60px',height:'100px',borderRadius:'10px'}}>
                    ...
                    <Text style={{fontSize:'22px',textAlign:'center', fontWeight:'bold',textTransform:'uppercase'}}>{tenTK}</Text>
                    <Text style={{fontSize:'17px',textAlign:'center'}}>{soTK}</Text>
                    <Text style={{fontSize:'17px',textAlign:'center'}}>{nganHang}</Text>
                </View>
            </View>
            ...
            <View style={{flex:1,width:'90%'}}>
                <View style={{flexDirection:'row',justifyContent:'space-around'}}>
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-evenly',border:'1px solid black',height:'40px',borderRadius:'20px'}}>
                        <EvilIcons name="user" size={24} color="blue" />
                        <Text style={{color:'blue'}}>Lưu người thụ hưởng</Text>
                    </View>
                    <View style={{flexDirection:'row',justifyContent:'space-evenly',alignItems:'center',border:'1px solid black',height:'40px',borderRadius:'20px'}}>
                        <MaterialCommunityIcons name="note-multiple-outline" size={24} color="blue" />
                        <Text style={{color:'blue'}}>Lưu mẫu giao dịch</Text>
                    </View>
                </View>
